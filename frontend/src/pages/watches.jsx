...
const Watches = () => {
  ...
  useEffect(() => {
    axios
      .get("/api/user/findwatches")
      .then((response) => {
        console.log("API Response for Watches:", response.data);
        setWatches(response.data.Watches || []); // FIXED: Uses correct key
      })
      .catch((err) => {
        console.error("Error fetching Watches data:", err);
  ...
  return (
    <div className="container mx-auto p-6">
      <h2 className="text-2xl font-bold text-center mb-6">Watches Collection</h2>
